...
namespace Manage
{
    ...
    public class UserOperationLogController : Controller
    {
        ...
        public ActionResult Data(CommViewModel<UserViewModel> model)
        {
            ...
            vModel.ViewModelList = ManageBaseBLL.GetDefinedList(searchModel, model.PageIndex, model.PageSize, false).ConvertAll(ModelConvert);

            Int32 count = ManageBaseBLL.GetDefinedCount(searchModel, false);
