...
namespace Moqikaka.GameManage
{
    ...
    public class RoleController : Controller
    {
        ...
        public ActionResult Data()
        {
            ...
            vModel.ViewModelList = GameManageBaseBLL.GetList<Role>().ConvertAll(ModelConvert);
        ...
        public JsonResult Create(CommViewModel<RoleViewModel> model, FormCollection collection)
        {
            ...
            try
            {
                ...
                if (GameManageBaseBLL.Insert<Role>(role) > 0)
                {
                    ret = true;
                }
        ...
        public JsonResult Delete(Int32 id)
        {
            ...
            try
            {
                if (GameManageBaseBLL.Delete<Role>(new Role() { ID = id }) > 0)
                {
                    ret = true;
                }
            }
        ...
        public ActionResult Edit(Int32 id)
        {
            ...
            try
            {
                var role = GameManageBaseBLL.GetList(new Role() { ID = id }).FirstOrDefault();
                if (role != null)
                {
        ...
        public JsonResult EditSubmit(CommViewModel<RoleViewModel> model, FormCollection collection)
        {
            ...
            try
            {
                var role = GameManageBaseBLL.GetList(new Role() { ID = model.ViewModel.Id }).FirstOrDefault();
                if (role != null)
                {
                    role = new Role
                    {
                    ...
                    if (GameManageBaseBLL.Update(role) > 0)
                    {
                        ret = true;
                    }
                }
        ...
        public ActionResult Exist(CommViewModel<RoleViewModel> model)
        {
            ...
            if (GameManageBaseBLL.GetDefinedCount(new Role { RolesName = model.ViewModel.RolesName }, false) > 0)
            {
